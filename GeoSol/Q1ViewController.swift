...
//    let appDel: AppDelegate = UIApplication.shared.delegate as! AppDelegate
    ...
    func recordData(){
        ...
        //imageをアプリ内に保存
        let fileName = "q" + String(problemID!) + "_" + String(userID!) + "_" + String(solution) + ".png"
    ...
    @IBAction func nextQuestion(_ sender: Any) {
        let alert: UIAlertController = UIAlertController(title: "終わりますか？", message: "", preferredStyle:  UIAlertController.Style.alert)
